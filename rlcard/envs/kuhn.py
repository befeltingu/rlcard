...
class KuhnEnv(Env):
    ...
    def __init__(self, config):
        ...
        self.state_shape = [[11] for _ in range(self.num_players)]
    ...
    def _extract_state(self, state):
        ...
        obs[state['my_chips']+2] = 1
        print("My chips: " + str(state['my_chips']))
        print("All chips: " + str(state['all_chips']))
        obs[sum(state['all_chips'])-state['my_chips']+6] = 1
